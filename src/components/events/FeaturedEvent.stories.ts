...
const meta: Meta<typeof FeaturedEvent> = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Large featured event card for the upcoming event. Includes a "Register Now" button and prominent imagery.',
      },
    },
    layout: 'padded',
  },
...
export const Default: Story = {
  args: {
    event: {
      ...
      shortDescription: 'Join hundreds of engineering students in our intensive summer bootcamp focusing on modern web technologies, AI, and digital freedom.',
