...
const meta: Meta<typeof FeaturedProjectsCarousel> = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Horizontal scrolling carousel for FeaturedProjects. Includes drag to scroll and autoplay functionality.",
      },
    },
    layout: "fullscreen",
  },
  ...
  args: {
    projects: [
      ...
      },
      {
        title: "Swecha GIS",
        description:
          "A geographic information system for mapping public resources and enabling data-driven governance.",
        imageLabel: "Mapping",
        image:
