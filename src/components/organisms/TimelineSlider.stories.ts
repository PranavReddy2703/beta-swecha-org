...
const meta: Meta<typeof TimelineSlider> = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Interactive horizontal node graph representing the timeline. Connects to the vertical scroll observer in the main Timeline.",
      },
    },
    layout: "padded",
  },
    ...
    events: [
      {
        year: "2005",
        title: "The Inception",
        description: "Started the first Telugu OS",
      },
      {
        year: "2010",
        title: "Community Growth",
        description: "100+ workshops",
      },
      { year: "2015", title: "Bala Swecha", description: "OS for schools" },
      {
        year: "2020",
        title: "AI for Local Languages",
        description: "Vishwam AI initiated",
      },
    ],
  },
  decorators: [
