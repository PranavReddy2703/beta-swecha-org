...
export const Default: Story = {
  args: {
    event: {
      ...
      shortDescription: 'Collaborate with fellow developers, build innovative solutions, and explore the future of open-source AI technologies during this 24-hour hackathon.',
...
export const ActiveWithGreenGlow: Story = {
  args: {
    event: {
      ...
      shortDescription: 'Join the statewide data collection initiative to build the largest open-source Telugu language dataset for training next-generation AI models.',
