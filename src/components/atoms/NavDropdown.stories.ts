...
const meta: Meta<typeof NavDropdown> = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Desktop navigation dropdown with hover-triggered menu. Shows a list of child links with icons, used for the Initiatives section.",
      },
    },
  },
  argTypes: {
    ...
    isActive: {
      control: "boolean",
      description: "Whether the parent route is active",
    },
    items: {
      control: "object",
      description:
        "Array of dropdown items with name, href, and optional icon SVG",
    },
  },
};
...
export const Default: Story = {
  args: {
    ...
    items: [
      ...
      {
        name: "People's Health",
        href: "/initiatives/peoples-health",
        icon: starIcon,
      },
      { name: "Code4Change", href: "/initiatives/code4change", icon: starIcon },
    ],
  },
};
...
export const ActiveParent: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Dropdown with active parent indicator (shows underline and brand color).",
      },
    },
  },
};
...
export const SingleItem: Story = {
  args: {
    label: "Resources",
    isActive: false,
    items: [{ name: "Documentation", href: "/docs", icon: starIcon }],
  },
};
