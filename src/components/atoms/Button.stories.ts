...
const meta: Meta<typeof Button> = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Primary and secondary CTA button component. Primary uses the brand cyan fill, secondary uses a glass outline style.',
      },
    },
  },
  argTypes: {
    ...
    target: { control: 'select', options: ['_self', '_blank'], description: 'Link target' },
    class: { control: 'text', description: 'Additional CSS classes for size/shadow overrides' },
  },
};
...
export const PrimaryWithGlow: Story = {
  args: {
    ...
    variant: 'primary',
    href: '#',
    class: 'px-8 py-4 shadow-[0_0_30px_rgba(0,212,255,0.25)] hover:shadow-[0_0_40px_rgba(0,212,255,0.4)]',
  },
  parameters: {
    docs: { description: { story: 'Primary button with enhanced glow shadow, used in hero CTAs.' } },
  },
};
...
export const Disabled: Story = {
  ...
  parameters: {
    docs: { description: { story: 'Simulated disabled state via CSS classes.' } },
  },
};
...
export const ButtonPair: Story = {
  ...
  `,
  parameters: {
    docs: { description: { story: 'Typical CTA pair layout as seen in hero sections.' } },
  },
};
