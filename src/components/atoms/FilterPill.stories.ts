...
const meta: Meta<typeof FilterPill> = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Interactive filter pill button used in the events timeline for category-based filtering. Highlights with brand cyan on selection.",
      },
    },
  },
  argTypes: {
...
export const FilterRow: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "A row of filter pills showing default and active states.",
      },
    },
  },
};
