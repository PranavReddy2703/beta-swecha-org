...
const en = {
  ...
  "contact.subtitle":
    "We'd love to hear from you. Connect with the Swecha community through any of the channels below.",
  ...
  "contact.cta.desc":
    "We're always excited to work with contributors, volunteers, educators, and open-source enthusiasts.",
  ...
  "news.subtitle":
    "Latest announcements, community initiatives, AI developments, open-source projects, events, and technology updates from Swecha.",
  ...
  "event.description":
    "A stakeholder consultation event exploring responsible AI development, governance, transparency, and community participation.",
  ...
  "event.cta.desc":
    "Be part of shaping the future of AI governance. Register to reserve your seat at IIIT Hyderabad.",
  ...
  "events.title": "Events",
  "events.subtitle":
    "Explore upcoming conferences, hackathons, workshops, meetups, and open-source community programs organized by Swecha.",
  ...
  "donations.subtitle":
    "Your contribution helps Swecha bridge the digital divide, build free software solutions, and empower communities across India with open-source technology and digital literacy.",
  ...
  "donations.why.desc":
    "Swecha is a community-driven organization dedicated to providing free software solutions and bridging the digital divide. Every donation directly supports our mission of digital inclusion, education, and community-driven open-source development.",
  "donations.why.education.title": "Digital Education",
  "donations.why.education.desc":
    "Fund digital literacy programs in government schools and rural communities across Telangana.",
  "donations.why.foss.title": "Free Software Development",
  "donations.why.foss.desc":
    "Support development of Telugu-localized free software, Swecha OS, and AI initiatives like VISHWAM.ai.",
  "donations.why.community.title": "Community Building",
  "donations.why.community.desc":
    "Enable workshops, hackathons, DevDays, and community meetups that bring together developers and students.",

  "donations.methods.title": "How to Donate",
  "donations.methods.subtitle":
    "Choose your preferred method to make a contribution to Swecha.",

  "donations.method.bank.title": "Bank Transfer (NEFT/RTGS)",
  "donations.method.bank.desc":
    "Make a direct bank transfer to Swecha's official account.",
  ...
  "donations.method.cheque.desc":
    "Send a cheque or DD payable to Swecha at our registered address.",
  ...
  "donations.tax.desc":
    "Donations to Swecha are eligible for tax exemption under Section 80G of the Income Tax Act. A receipt will be issued for all donations. Please contact us at reachus@swecha.net for your tax exemption certificate.",

  "donations.cta.title": "Every Contribution Counts",
  "donations.cta.desc":
    "Whether big or small, your donation makes a real difference in empowering communities with free software and digital literacy.",
